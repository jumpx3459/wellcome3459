...
export const categoryKeywords: Record<string, string[]> = {
  ...
  전자제품: ["가전", "전자제품", "냉장고", "세탁기", "청소기", "에어컨"],
  산업원자재: ["원단", "철강", "원사", "산업자재", "화학원료", "플라스틱원료"],
  기계설비: ["기계", "설비", "공구", "모터", "펌프", "밸브"],
  "가공식품·잡화": ["라면", "과자", "음료", "통조림", "소스", "조미료", "가공식품"],
  가구: ["침대", "소파", "책상", "의자", "가구", "수납장"],
  "건강·위생용품": ["마스크", "손소독제", "비타민", "건강기능식품", "위생용품"],
  "IT·사무기기": ["노트북", "컴퓨터", "모니터", "프린터", "키보드"],
  "사무용품·비품": ["문구", "사무용품", "복사용지", "토너"],
  자동차용품: ["자동차용품", "타이어", "차량부품", "워셔액", "엔진오일"],
  반려동물용품: ["강아지", "고양이", "사료", "반려동물", "애견", "애묘"],
  "완구·유아용품": ["장난감", "완구", "기저귀", "유아용품", "젖병"],
  혼합재고: ["혼합재고", "잡화모음", "다품목"],
  기타: [],
};
